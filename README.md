...
<p align="center"><b>Рисунок 1. Размеченный кадр</b></p>
...
Максимальное значение у всех моделей одинаковое. Будем считать лучшими модели, у которых порог confidence при максимальном значении F1 выше. Это означает, что модель больше уверена в своих предсказаниях. Это модели 2 и 3.
...
Модели очень осторожны и аккуратны, когда выбирают предсказания — почти не ошибаются. Но когда они пытаются работать на полном наборе, то резко начинают делать множество ошибок из-за чего precision падает при recall равным 1.
